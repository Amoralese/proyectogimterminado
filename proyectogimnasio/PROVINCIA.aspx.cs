...
namespace proyectogimnasio
{
    public partial class PROVINCIA : System.Web.UI.Page
    {
        ...
        protected void Bingresarprovincia_Click(object sender, EventArgs e)
        {
            ...
            conexion.Open();
            SqlCommand comando = new SqlCommand(" INSERT INTO provincia VALUES( '" + TNombreprovincia.Text + "'  )", conexion);
        ...
        protected void BActualizarprovincia_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conexion = new SqlConnection(s);
            conexion.Open();
            SqlCommand comando = new SqlCommand(" update Provincia set nombre = '" + TNombreprovincia.Text + "'   where CODIGO  = '" + TCodigoprovincia.Text + "'", conexion);
            comando.ExecuteNonQuery();
            conexion.Close();
            LlenarGrid();
        }
