    ...
    <form id="form1" runat="server">
        <div>
            <table style="width: 100%;" border="2">
                ...
                <tr>
                    <td class="auto-style3"><strong>Codigo Cliente</strong></td>
                ...
                <tr>
                    <td class="auto-style4">
                        <asp:TextBox ID="tcodigocliente" runat="server"></asp:TextBox>&nbsp;&nbsp;
                        </td>
                    <td class="auto-style1">
                        <asp:TextBox ID="tnombrecliente" runat="server" Width="216px" Enabled="False"></asp:TextBox></td>
                    <td class="auto-style1">
                        <asp:TextBox ID="tfecha" runat="server" Enabled="False"></asp:TextBox></td>
                    <td class="auto-style1">
